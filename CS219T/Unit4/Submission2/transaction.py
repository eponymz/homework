class Transaction:
    ...
    def loadTransaction(self):
        self.setAmount(float(raw_input("Enter transaction amount(DD.CC):\n$")))
        self.setCode(raw_input("Enter transaction code('W' or 'D')\n"))
        self.setNote(raw_input("Enter purpose of transaction:\n"))
